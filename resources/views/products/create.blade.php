    ...
    <form action="{{route('products.store')}}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="code" id="code" class="form-control" placeholder="Codigo del Producto" maxlength="8" required>
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="price" id="price" class="form-control" placeholder="Precio del Producto" required>
            </div>
            <div class="col-md-6 mb-3">
                <label for="">Cantidad</label>
                <input type="number" name="ammount" id="ammount" class="form-control" placeholder="Cantidad del Producto">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
